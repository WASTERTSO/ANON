    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="𝐴𝑢𝑑𝑖𝑜 𝑄𝑢𝑎𝑙𝑖𝑡𝑦", callback_data="AQ"
            ),
            InlineKeyboardButton(
                text="𝑉𝑖𝑑𝑒𝑜 𝑄𝑢𝑎𝑙𝑖𝑡𝑦", callback_data="VQ"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝐴𝑢𝑡𝒉 𝑈𝑠𝑒𝑟𝑠", callback_data="AU"
            ),
            InlineKeyboardButton(
                text="𝐶𝑙𝑒𝑎𝑛 𝑀𝑜𝑑𝑒", callback_data="CM"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝑆𝑢𝑝𝑝𝑜𝑟𝑡 🚑", url=f"{SUPPORT_GROUP}",
            ),
            InlineKeyboardButton(
